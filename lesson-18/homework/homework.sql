-- 1 & 2 & 3 & 4: Products and Sales Tables
------------------------------------------------------
...
END;
GO
SELECT dbo.fn_IsPrime(7) AS SevenIsPrime, dbo.fn_IsPrime(9) AS NineIsPrime;
